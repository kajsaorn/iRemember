...
public class UserMessage {
    ...
    public static final String SAVED_ROOM_NAME = "Ditt rumsnamn är sparat.";
    public static final String SAVED_MASTER_SERVICE = "Din köksenhet är sparad.";
    ...
    public static final String HOST_FAILURE = "IP-adressen du har angett för köksenheten verkar inte stämma.";
    ...
    public static final String MISSING_IP_ADDRESS = "Vänligen ange köksenhetens IP-adress";
